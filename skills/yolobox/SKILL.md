...
4. Call out the important operating assumptions for the current session:
   ...
   - write access, output path, network access, Docker access, env passthrough, host clipboard/open bridges, and forwarded env keys depend on the current manifest
